...
PBDNSMessage = _reflection.GeneratedProtocolMessageType('PBDNSMessage', (_message.Message,), dict(
  ...
  DNSResponse = _reflection.GeneratedProtocolMessageType('DNSResponse', (_message.Message,), dict(
    ...
    DNSRR = _reflection.GeneratedProtocolMessageType('DNSRR', (_message.Message,), dict(
