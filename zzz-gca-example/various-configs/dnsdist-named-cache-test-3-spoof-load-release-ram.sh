echo "dnsdist2-named-cache-test-3-spoof-load-release-ram.sh - test dnsdist with named cache version test 3 spoof bind with force release ram- Ari's version"
echo ""
